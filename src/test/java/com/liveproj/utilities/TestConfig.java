...
public class TestConfig{
	...
	public static String from = "automationpractise2019@gmail.com";
	public static String password = "96gqee2022";
	public static String[] to ={"reportrecipient2019@gmail.com"};
